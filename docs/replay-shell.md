...
- The graph stage now runs on the shared execution-engine package for Breadth-First Search, Depth-First Search, Dijkstra, Network Delay Time, Clone Graph, Graph Valid Tree, Count Connected Components, Redundant Connection, Course Schedule, Course Schedule II, Rotting Oranges, Number of Islands, Max Area of Island, Island Perimeter, Pacific Atlantic Water Flow, Shortest Bridge, Shortest Path in Binary Matrix, Nearest Exit from Entrance in Maze, Shortest Path in a Grid with Obstacles Elimination, Minimum Obstacle Removal to Reach Corner, Swim in Rising Water, Shortest Path to Get Food, 01 Matrix, As Far from Land as Possible, Map of Highest Peak, Surrounded Regions, and Walls and Gates, so queue order, top-first stack order, weighted frontier order, weighted-broadcast arrival ledgers, clone-map allocation, Union-Find root comparison, component-count checkpoints, first-cycle detection, zero-indegree unlocks, committed topological-order checkpoints, minute-wave infection spread, row-major scan checkpoints, largest-island area ledgers, coastline edge ledgers, dual-ocean reachability ledgers, first-island marking, bridge-wave expansion, blocked-cell ledgers, predecessor traceback, nearest-boundary-exit traceback, obstacle-budget dominance pruning, minimum-removal deque ordering, weighted water-level relaxations, pantry-target traceback, nearest-zero distance fills, shoreline-distance fills, water-seeded height fills, border-safe ledgers, row-major capture queues, room-distance fills, and terminal stall reporting all come from one deterministic runtime family.
- Graph replay now pairs the SVG graph map or grid stage with a structural-state rail for node, course, or cell status, distance, arrival time, unreachable coverage, clone label, representative-root, parent-rank, redundant-edge verdicts, indegree, dual-ocean reachability, first-island membership, bridge-wave water expansion, blocked-open cell status, traceback path, nearest-boundary-exit ledgers, obstacle-budget state queues, weighted water-level ledgers, pantry-target ledgers, nearest-zero distance fills, shoreline-distance ledgers, height-map ledgers, safe-region, capture queue, or room-distance inspection, plus path-, relay-, clone-link-, accepted-edge-, rejected-edge-, order-, infection-, connectivity-, bridge-, capture-, or distance-fill focus so the interface can surface graph state without inventing browser-only metadata.
